...
jvm.$ = jQuery, Array.prototype.indexOf || (Array.prototype.indexOf = function(l, t) {
    ...
    setScale: function(l, t, e, a, i) {
        var s, n, r, h, o, m, p, c, d, u = jvm.$.Event("zoom.jvectormap"),
            ...
            f = new jvm.$.Deferred;
        return l > this.params.zoomMax * this.baseScale ? l = this.params.zoomMax * this.baseScale : l < this.params.zoomMin * this.baseScale && (l = this.params.zoomMin * this.baseScale), void 0 !== t && void 0 !== e && (zoomStep = l / this.scale, a ? (c = t + this.defaultWidth * (this.width / (this.defaultWidth * l)) / 2, d = e + this.defaultHeight * (this.height / (this.defaultHeight * l)) / 2) : (c = this.transX - (zoomStep - 1) / l * t, d = this.transY - (zoomStep - 1) / l * e)), i && 0 < g ? (n = this.scale, r = (l - n) / g, h = this.transX * this.scale, m = this.transY * this.scale, o = (c * l - h) / g, p = (d * l - m) / g, s = setInterval(function() {
            v += 1, M.scale = n + r * v, M.transX = (h + o * v) / M.scale, M.transY = (m + p * v) / M.scale, M.applyTransform(), v == g && (clearInterval(s), M.container.trigger(u, [l / M.baseScale]), f.resolve())
    ...
    setFocus: function(l) {
        ...
        if ((l = l || {}).region ? a = [l.region] : l.regions && (a = l.regions), a) {
            for (i = 0; i < a.length; i++) this.regions[a[i]] && ((e = this.regions[a[i]].element.shape.getBBox()) && (void 0 === t ? t = e : t = {
                x: Math.min(t.x, e.x),
                y: Math.min(t.y, e.y),
