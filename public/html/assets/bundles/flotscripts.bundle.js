        ...
        function l() {
            ...
            M = d.width - w.left - w.right, T = d.height - w.bottom - w.top, Q.each(t, function(e, t) {
                    ! function(e) {
                        ...
                        "x" == e.direction ? (i = e.scale = M / Math.abs(o(e.max) - o(e.min)), n = Math.min(o(e.max), o(e.min))) : (i = -(i = e.scale = T / Math.abs(o(e.max) - o(e.min))), n = Math.max(o(e.max), o(e.min))), e.p2c = o == t ? function(e) {
                            return (e - n) * i
                        } : function(e) {
                            return (o(e) - n) * i
                        }, e.c2p = r ? function(e) {
